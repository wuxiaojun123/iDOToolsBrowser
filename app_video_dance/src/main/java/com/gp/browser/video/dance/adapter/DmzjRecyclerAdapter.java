package com.gp.browser.video.dance.adapter;
...
import com.gp.browser.video.dance.adapter.viewHolder.FooterViewHolder;
import com.gp.browser.video.dance.adapter.viewHolder.Header2ViewHolder;
import com.gp.browser.video.dance.adapter.viewHolder.HeaderViewHolder;
...
import com.gp.browser.video.dance.adapter.viewHolder.DmzjViewHolderType2;
import com.gp.browser.video.dance.adapter.viewHolder.DmzjViewHolderTypeAd;
import com.gp.browser.video.dance.manager.viewpager.ViewPagerManager;
...
public class DmzjRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        } else if (holder instanceof HeaderViewHolder) { // 第一个头部布局
            HeaderViewHolder headerViewHolder = (HeaderViewHolder) holder;
            initBannerAdapter(headerViewHolder);

        } else if (holder instanceof Header2ViewHolder) { // 第二个头部布局
     ...
     * 初始化banner
     */
    private void initBannerAdapter(HeaderViewHolder headerViewHolder) {
