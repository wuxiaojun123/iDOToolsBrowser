package com.gp.browser.video.dance.manager.http;

import com.gp.browser.video.dance.bean.BannerResp;
import com.gp.browser.video.dance.bean.DmzjBean;
import com.gp.browser.video.dance.minterface.APIService;
...
public class AppHttpClient {
    ...
    public void requestBannerPath(String packageName, int versionCode) {
        ...
        Call<BannerResp> bannerBeanList1 = apiService.getBannerBeanList(packageName, "fans001");
        //异步请求网络信息
