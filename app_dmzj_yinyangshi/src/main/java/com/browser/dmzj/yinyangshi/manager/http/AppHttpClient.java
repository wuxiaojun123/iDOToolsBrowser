package com.browser.dmzj.yinyangshi.manager.http;

import com.browser.dmzj.yinyangshi.bean.BannerResp;
import com.browser.dmzj.yinyangshi.bean.DmzjBeanResp;
import com.browser.dmzj.yinyangshi.minterface.APIService;
...
public class AppHttpClient {
    ...
    public void requestBannerPath(String packageName, int versionCode) {
        ...
        Call<BannerResp> bannerBeanList1 = apiService.getBannerBeanList(packageName, Constant.BANNER_CODE);
        //异步请求网络信息
