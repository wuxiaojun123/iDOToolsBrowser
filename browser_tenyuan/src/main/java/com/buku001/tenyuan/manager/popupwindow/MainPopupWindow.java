package com.buku001.tenyuan.manager.popupwindow;
...
import com.buku001.tenyuan.activity.AboutActivity;
import com.buku001.tenyuan.activity.HistoryActivity;
import com.buku001.tenyuan.activity.MainActivity;
import com.buku001.tenyuan.manager.dialog.AlertDialog;
import com.buku001.tenyuan.manager.webview.WebViewManager;
import com.buku001.tenyuan.utils.ShareUtils;
import com.buku001.tenyuan.utils.ShortCutUtils;
import com.buku001.tenyuan.view.ImageTextViewGroup;
...
//            pw.showAtLocation(rootView, Gravity.NO_GRAVITY, 0, 0);
    ...
    @OnClick({R.id.id_ll_empty, R.id.id_share, R.id.id_history,
            ...
            R.id.id_about, R.id.id_exit, R.id.id_feedback})
    @Override
